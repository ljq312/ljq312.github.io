...
*	Evaluated the effect of Advantage program on the number of NYC homeless people by constructing a linear regression model. The model explained 85% of the number of homeless people variation.
* Manipulated data and built data visualization to help understanding data change patterns and how the number of the homeless related to other variables.
