...
* **Linear Regression & Nonlinear Regression: ** Fitting Linear Regression using least squares, ridge, lasso, partial least squares. Fitting Nonlinear Regression using spline and generalized additive model. Report is availabe [here](Downloads/hw1.html)
* **Classification: **Classify market returns (positive or negative) for the S&P 500 stock index using Logistic Regression, Linear Discriminant Analysis, Quadratic Diescriminant Analysis, K-Nearest-Neighbor classifier. Report is available [here](Downloads/hw2.html)
